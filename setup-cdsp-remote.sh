...
install_bluetooth_remote() {
    ...
    wget -q https://raw.githubusercontent.com/melomane63/tm1637_lgpio/main/tm1637_lgpio.py -O "/opt/venv/lib/python${PYVER}/site-packages/tm1637_lgpio.py"
...
EOL
    ...
    echo "⚠️  settings.json n'est pas telecharge automatiquement (reglages audio personnels)."
    echo "    Copiez-le depuis votre ancien Pi si vous en avez un : scp pi@<IP>:~/settings.json ~/"
}
